...
class _QRScanViewState extends State<QRScanView> {
  ...
  Widget _buildQrView(BuildContext context) {
    ...
    var scanArea =
    (MediaQuery.of(context).size.width < 400 || MediaQuery.of(context).size.height < 400) ? 250.w : 400.w;
    ...
    return QRView(
      ...
      overlay: QrScannerOverlayShape(
        overlayColor: colors(context).surface,
          borderColor: MainColors.appBlueColor, borderRadius: 10, borderLength: 30, borderWidth: 10, cutOutSize: scanArea),
